      ...
      <Wrapper className="h-[60px] flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 text-black">
          ...
          <div className="w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center hover:bg-black/[0.05] cursor-pointer relative">
            <IoMdHeartEmpty className="text-[18px] md:text-[23px]" />
            <div className="h-[14px] md:h-[18px] min-w-[14px] md:min-w-[18px] rounded-full bg-rose-600 absolute top-1 left-5 md:left-7 text-white text-[10px] md:text-xs flex justify-center items-center px-[2px] md:px-[5px] font-semibold">2</div>
          </div>

          <Link href="/cart">
            <div className="w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center hover:bg-black/[0.05] cursor-pointer relative">
              <BsCart className="text-[15px] md:text-[20px]" />
              {cartItems.length > 0 && <div className="h-[14px] md:h-[18px] min-w-[14px] md:min-w-[18px] rounded-full bg-rose-600 absolute top-1 left-5 md:left-7 text-white text-[10px] md:text-xs flex justify-center items-center px-[2px] md:px-[5px] font-semibold">
                {cartItems.length}
              </div>}
            </div>
          </Link>
          ...
          <div className="w-8 md:w-12 h-8 md:h-12 md:hidden rounded-full flex justify-center items-center hover:bg-black/[0.05] cursor-pointer relative -mr-2">
            {mobileMenu ? (
              ...
              <BiMenuAltRight className="text-[19px]" onClick={() => setMobileMenu(true)} />
            )}
          </div>
